 ...
 */
namespace News\DeleteContentHandler;

use Application\DeleteContent\ApplicationAbstractDeleteContent;

class NewsHandler extends ApplicationAbstractDeleteContent
{
    /**
     * Delete items limit
     */
    ...
    public function deleteItems()
    {
        ...
        if (null != ($newsList = $this->getModel()->getUnusedNews(self::DELETE_ITEMS_LIMIT))) {
            foreach ($newsList as $item) {
                if (true === ($result = $this->getModel()->deleteNews($item))) {
                    $itemsDeleted++;
                }
            }
        }
